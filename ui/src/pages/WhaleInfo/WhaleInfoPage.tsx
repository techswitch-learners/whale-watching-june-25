...
const WhaleInfoPage: React.FunctionComponent = () => {
    ...
    return (
        <div className="whale-info">
            ...
            <h3 className="subtitle">If you’ve never seen a whale before, it can be hard to know what to look for. <br/> Here are some general and specific tips that may help you see and identify specific species.</h3>
